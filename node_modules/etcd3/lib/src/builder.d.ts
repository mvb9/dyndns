...
export declare class MultiRangeBuilder extends RangeBuilder<{
     ...
     */
    keys(encoding?: string): Promise<string[]>;
    /**
     ...
     * string, or `null` if it isn't found.
     */
    strings(encoding?: string): Promise<{
        [key: string]: string;
    }>;
    /**
...
export declare class ComparatorBuilder {
     ...
     */
    mapOperations(ops: (RPC.IRequestOp | IOperation)[]): RPC.IRequestOp[];
}
